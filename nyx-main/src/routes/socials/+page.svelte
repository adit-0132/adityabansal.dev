<script>
	...
	const emailHref = `mailto:${site.brand.contactEmail}`;
</script>

<svelte:head>
	<title>Connect with {site.identity.name} | Social Links</title>
	<meta
		name="description"
		content={`Connect with ${site.identity.name} across the web.`}
	/>
</svelte:head>
...
<div class="mx-auto max-w-4xl px-4 py-6 sm:px-6 md:py-12">
	...
	<div class="mt-12 text-center">
		<p class="text-subtext1 text-sm">
			...
			<a href={emailHref} class="link text-accent font-medium hover:underline">
